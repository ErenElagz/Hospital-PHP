...
if (isset($_POST['submit'])) {
    ...
    mysqli_query($dbcon, "insert into `patients` (name,surname,id_number,phone,email,department) values('$name','$surname','$id_number','$phone','$email','$department')");
} ?>
        ...
        <form method="post" class=" p-0 col d-flex flex-column align-items-center justify-content-center">
            <div class="w-100 bg-light -10 rounded-4 p-4">
                ...
                <div class="d-flex gap-2 mt-3">
                    ...
                    <button class="btn btn-success w-100 rounded-3 text-light" name="submit" type="submit">Add Patient
                    </button>
                </div>
            </div>
        </form>
