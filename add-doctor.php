...
if (isset($_POST['submit'])) {
    ...
    mysqli_query($dbcon, "insert into `doctors` (name,surname,id_number,phone,email,department,wage,specialty) values('$name','$surname','$id_number','$phone','$email','$department','$wage','$specialty')");
} ?>
    ...
    <section class="container mt-3 row m-auto p-0">
        ...
        <form method="post" class=" p-0 col d-flex flex-column align-items-center justify-content-center">
            <div class="w-100 bg-light -10 rounded-4 p-4">
                ...
                <div class="input-group mb-2">
                    <div class="input-group-prepend">
                        <div class="input-group-text">Specialty</div>
                    </div>
                    <input type="text" class="form-control" id="PhoneInput" name="specialty" required />
                </div>
                <!--Button-->
                <div class="d-flex gap-2 mt-3">
                    <button class="btn btn-danger w-100 rounded-3 " type="reset">Clear the Form</button>
                    <button class="btn btn-success w-100 rounded-3 text-light" name="submit" type="submit">Add Doctor
                    </button>
                </div>
            </div>
        </form>
